...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, { class: "text-right" }, {}, {
        trail: () => {
          return `${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})} `;
        },
        default: () => {
          return `<a class="btn btn-sm" href=" " rel="noreferrer" data-svelte-h="svelte-1q0uz67">Home</a> <a class="btn btn-sm" href=" " rel="noreferrer" data-svelte-h="svelte-8toljk">Blog</a> `;
        },
        lead: () => {
          return `<strong class="text-xl uppercase" data-svelte-h="svelte-kqjnl">Salvatore Campisano</strong>`;
        }
      })} `;
    },
    default: () => {
